...
<div>
	<section class=" bg-primary grid min-w-screen h-fit sm:grid-cols-2 sm:grid-rows-1 p-4 text-secondary">
		<div class="m-8 sm:flex hidden">
			<img
				src="finalLogo.svg"
				class="h-6 self-end justify-self-start sm:h-24"
				alt="Green Basil Logo"
			/>
		</div>

		<div class="m-2 sm:m-8 flex-col">
			...
			<div class=" mt-4 sm:mt-12 mb-6 grid grid-cols-2 border-b-2 pb-6">
				<div class="flex flex-col justify-end mb-8 sm:mb-0">
					<div class="flex flex-wrap">
						...
						<a href="https://www.instagram.com/greenbasilthai.yvr/" target="_blank">
							<img
								...
								class="h-6 self-end justify-self-start sm:h-8"
								alt="link to the Green Basil Thai Instagram Account"
							/>
						</a>

						<a href="https://www.facebook.com/GreenBasil/" target="_blank">
							<img
					...
					<a
						href="order"
						class="mt-2 h-fit w-fit rounded-xl border-1 sm:border-2 border-[#E0B87A] p-2 md:4 text-sm md:text-lg hover:font-bold"
						>Make Reservation</a
					>
				</div>
				<div class="font-DMSans text-secondary mb-8 sm:mb-0 mx-4 sm:ml-4 md:ml-8 flex-col flex-nowrap text-xs font-extralight tracking-wide">
					<a
						class=" underline"
					...
					<p class="mt-4 mb-4">5PM - 10PM WD/ 10:30PM WE</p>

					<a class="underline" href="tel:+16044391919">+1 (604) 439-1919</a>
				</div>
			...
			<p class="font-DMSans font-thin sm:font-extralight">© 2025 All Rights Reserved. Green Basil Thai Cuisine</p>
		</div>
	</section>
</div>
