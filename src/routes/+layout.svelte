...
<div class="cursor-custom overflow-clip">
	...
	{#if $page.url.pathname !== '/' && $page.url.pathname !== '/full-menu' && $page.url.pathname !== '/home' && $page.url.pathname !== '/identity' && $page.url.pathname !== '/contact' && $page.url.pathname !== '/hours-location'}
